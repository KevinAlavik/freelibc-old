...
#ifndef __FREELIBC_CTYPE_GCC_H
#define __FREELIBC_CTYPE_GCC_H

#if defined(__FREELIBC_DEF_CTYPE_GCC)
...
#endif // __FREELIBC_DEF_CTYPE_GCC

#endif // __FREELIBC_CTYPE_GCC_H
