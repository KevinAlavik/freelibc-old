...
#ifndef __FREELIBC_STRING_GCC_H
#define __FREELIBC_STRING_GCC_H

#if defined(__FREELIBC_DEF_STRING_GCC)
...
#endif // __FREELIBC_DEF_STRING_GCC

#endif // __FREELIBC_STRING_GCC_H
